CREATE TABLE [dbo].[JazzCashTransaction] (
    [JazzCashTransactionId] INT              IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_JazzCashTransaction] PRIMARY KEY CLUSTERED ([JazzCashTransactionId] ASC)
);
