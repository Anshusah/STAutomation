...
namespace Themes.Core
{
    public class Setup:Theme{
        ...
        public void Init()
        {
            ...
            this.RegisterCss("main-frontend", "/Themes/"+  GetName(false) + "/css/main-frontend.css");
            this.RegisterCss("site", "/Themes/" + GetName(false) + "/css/site.css");
            this.RegisterCss("fontawesome", "/css/fontawesome/all.css");
            this.RegisterCss("td-datetime-css", "/css/bootstrap-datetimepicker.min.css");
            // Register Required JS
            this.RegisterJs("jquery", "/js/jquery-3.3.1.min.js");
            this.RegisterJs("popper", "/js/bootstrap4.1.3/popper.min.js");
            this.RegisterJs("popper", "/js/bootstrap4.1.3/popper.min.js");
            ...
            this.AddAction("after_case_switch", "OnAfterCaseSwitch", 0);
        }
        public void OnBeforeCaseSwitch(int switch_from=0,int switch_to=0,object[] estimates=null)
        {
            ...
            Type _type = Type.GetType("Themes.Blue.Components.CaseAutomation");
            ...
            objs.Theme = this;
            MethodInfo.Invoke(objs, new object[] { switch_from, switch_to, estimates });


        }
        public void OnAfterCaseSwitch(int switch_from = 0, int switch_to = 0, object[] estimates = null)
        {
