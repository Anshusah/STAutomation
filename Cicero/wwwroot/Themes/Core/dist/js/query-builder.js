...
(function (root, factory) {
    ...
    QueryBuilder.OPERATORS = {
        ...
        equal_field: { type: 'equal_field', nb_inputs: 1, multiple: false, apply_to: ['string', 'number', 'datetime', 'boolean'] },
        not_equal_field: { type: 'not_equal_field', nb_inputs: 1, multiple: false, apply_to: ['string', 'number', 'datetime', 'boolean'] },
        less_field: { type: 'less_field', nb_inputs: 1, multiple: false, apply_to: ['number', 'datetime'] },
        less_or_equal_field: { type: 'less_or_equal_field', nb_inputs: 1, multiple: false, apply_to: ['number', 'datetime'] },
        greater_field: { type: 'greater_field', nb_inputs: 1, multiple: false, apply_to: ['number', 'datetime'] },
        greater_or_equal_field: { type: 'greater_or_equal_field', nb_inputs: 1, multiple: false, apply_to: ['number', 'datetime'] }
    };
...
<div id="{{= it.rule_id }}" class="rule-container"> \
  <div class="rule-header"> \
    <div class="btn-group pull-right rule-actions abc"> \
  ...
  <label for="' + id + '">' + val + '</label> \
    ...
    QueryBuilder.defaults({
        operatorOpposites: {
            ...
            'is_null': 'is_not_null',
            'is_not_null': 'is_null',
            'equal_field': 'not_equal_field',
            'not_equal_field': 'equal_field',
            'less_field': 'greater_or_equal_field',
            'less_or_equal_field': 'greater_field',
            'greater_field': 'less_or_equal_field',
            'greater_or_equal_field': 'less_field',
        },
    ...
    QueryBuilder.defaults({
        mongoOperators: {
            ...
            equal_field: function (v) { return v[0]; },
            not_equal_field: function (v) { return { '$ne': v[0] }; },
            less_field: function (v) { return { '$lt': v[0] }; },
            less_or_equal_field: function (v) { return { '$lte': v[0] }; },
            greater_field: function (v) { return { '$gt': v[0] }; },
            greater_or_equal_field: function (v) { return { '$gte': v[0] }; },
            // @formatter:on
        },
    ...
    QueryBuilder.regional['en'] = {
        ...
        "operators": {
            ...
            "equal_field": "equal field",
            "not_equal_field": "not equal field",
            "less_field": "less field",
            "less_or_equal_field": "less or equal field",
            "greater_field": "greater field",
            "greater_or_equal_field": "greater or equal field",
        },
        "errors": {
