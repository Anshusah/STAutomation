...
namespace Cicero.Data.Cicero.Data.Migrations.SimpleTransferApplicationDb
{
    ...
    [Migration("20200507075340__applicantId_added_onfidoApplicant")]
    partial class _applicantId_added_onfidoApplicant
    {
            ...
            modelBuilder.Entity("Cicero.Data.Entities.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "17d59ab8-a192-4537-a625-3227c8e57ef7", ConcurrencyStamp = "0ed60e11-8c45-4934-b0c3-86207c874046", CreatedAt = new DateTime(2020, 5, 7, 13, 38, 39, 220, DateTimeKind.Local), CreatedBy = "df0d5fc1-b3c9-448f-afea-a43cd08005a6", DisplayName = " Customer", Name = "Customer SimpleTransfer", NormalizedName = "CUSTOMER SIMPLETRANSFER", OrganizationName = "Simple Transfer", Status = (short)1, TenantId = 14, Type = 1, UpdatedAt = new DateTime(2020, 5, 7, 13, 38, 39, 220, DateTimeKind.Local) },
                        new { Id = "ca4de2af-8d15-4c49-bc12-0a22d7cdf43d", ConcurrencyStamp = "0ed60e11-8c45-4934-b0c3-86207c874046", CreatedAt = new DateTime(2020, 5, 7, 13, 38, 39, 220, DateTimeKind.Local), CreatedBy = "df0d5fc1-b3c9-448f-afea-a43cd08005a6", DisplayName = " Administrator", Name = "Administrator SimpleTransfer", NormalizedName = "Administrator SIMPLETRANSFER", OrganizationName = "Simple Transfer", Status = (short)1, TenantId = 14, Type = 1, UpdatedAt = new DateTime(2020, 5, 7, 13, 38, 39, 220, DateTimeKind.Local) }
                    );
                });
            ...
            modelBuilder.Entity("Cicero.Data.Entities.SimpleTransfer.CountryList", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Code = "AF", CreatedBy = "df0d5fc1-b3c9-448f-afea-a43cd08005a6", CreatedDate = new DateTime(2020, 5, 7, 13, 38, 39, 218, DateTimeKind.Local), CurrencyCode = "", CurrencyName = "", DisplayOrder = 0, FlagCode = "", FlagImageUrl = "", IsActive = false, Name = "Afghanistan", UpdatedBy = "df0d5fc1-b3c9-448f-afea-a43cd08005a6", UpdatedDate = new DateTime(2020, 5, 7, 13, 38, 39, 219, DateTimeKind.Local) },
                        new { Id = 2, Code = "AL", CreatedBy = "df0d5fc1-b3c9-448f-afea-a43cd08005a6", CreatedDate = new DateTime(2020, 5, 7, 13, 38, 39, 219, DateTimeKind.Local), CurrencyCode = "", CurrencyName = "", DisplayOrder = 0, FlagCode = "", FlagImageUrl = "", IsActive = false, Name = "Albania", UpdatedBy = "df0d5fc1-b3c9-448f-afea-a43cd08005a6", UpdatedDate = new DateTime(2020, 5, 7, 13, 38, 39, 219, DateTimeKind.Local) },
            ...
            modelBuilder.Entity("Cicero.Data.Entities.SimpleTransfer.Gender", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Code = "M", CreatedBy = "df0d5fc1-b3c9-448f-afea-a43cd08005a6", CreatedDate = new DateTime(2020, 5, 7, 13, 38, 39, 219, DateTimeKind.Local), Name = "Male", Status = true, TenantId = 14, UpdatedBy = "", UpdatedDate = new DateTime(2020, 5, 7, 13, 38, 39, 220, DateTimeKind.Local) },
                        new { Id = 2, Code = "F", CreatedBy = "df0d5fc1-b3c9-448f-afea-a43cd08005a6", CreatedDate = new DateTime(2020, 5, 7, 13, 38, 39, 220, DateTimeKind.Local), Name = "Female", Status = true, TenantId = 14, UpdatedBy = "", UpdatedDate = new DateTime(2020, 5, 7, 13, 38, 39, 220, DateTimeKind.Local) }
                    );
                });
            ...
            modelBuilder.Entity("Cicero.Data.Entities.SimpleTransfer.RateSupplier", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedAt = new DateTime(2020, 5, 7, 13, 38, 39, 218, DateTimeKind.Local), IsActive = true, Name = "Tranfast", Password = "P@ssw0rd", RatePriority = 1, SystemId = "1AB804F0-9252-4A7E-885A-276B65540D84", UpdatedAt = new DateTime(2020, 5, 7, 13, 38, 39, 217, DateTimeKind.Local), Username = "transfast" },
                        new { Id = 2, CreatedAt = new DateTime(2020, 5, 7, 13, 38, 39, 218, DateTimeKind.Local), IsActive = true, Name = "NecMoney", Password = "P@ssw0rd", RatePriority = 2, SystemId = "9D6D65E4-EFF1-4752-892D-3F637A56C159", UpdatedAt = new DateTime(2020, 5, 7, 13, 38, 39, 218, DateTimeKind.Local), Username = "necmoney" },
                        new { Id = 3, CreatedAt = new DateTime(2020, 5, 7, 13, 38, 39, 218, DateTimeKind.Local), IsActive = true, Name = "Safkhan", Password = "P@ssw0rd", RatePriority = 3, SystemId = "D93C65D4-7AA9-4A84-B23F-BEBB8D324476", UpdatedAt = new DateTime(2020, 5, 7, 13, 38, 39, 218, DateTimeKind.Local), Username = "safkhan" }
                    );
                });
