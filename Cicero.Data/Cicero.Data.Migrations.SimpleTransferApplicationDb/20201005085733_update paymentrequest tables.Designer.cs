...
namespace Cicero.Data.Cicero.Data.Migrations.SimpleTransferApplicationDb
{
    ...
    [Migration("20201005085733_update paymentrequest tables")]
    partial class updatepaymentrequesttables
    {
            ...
            modelBuilder.Entity("Cicero.Data.Entities.SimpleTransfer.RateSupplier", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedAt = new DateTime(2020, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), IsActive = true, Name = "Tranfast", Password = "P@ssw0rd", RatePriority = 1, SystemId = "1AB804F0-9252-4A7E-885A-276B65540D84", UpdatedAt = new DateTime(2020, 10, 5, 14, 42, 32, 665, DateTimeKind.Local), Username = "transfast" },
                        new { Id = 2, CreatedAt = new DateTime(2020, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), IsActive = true, Name = "NecMoney", Password = "P@ssw0rd", RatePriority = 2, SystemId = "9D6D65E4-EFF1-4752-892D-3F637A56C159", UpdatedAt = new DateTime(2020, 10, 5, 14, 42, 32, 666, DateTimeKind.Local), Username = "necmoney" },
                        new { Id = 3, CreatedAt = new DateTime(2020, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), IsActive = true, Name = "Safkhan", Password = "P@ssw0rd", RatePriority = 3, SystemId = "D93C65D4-7AA9-4A84-B23F-BEBB8D324476", UpdatedAt = new DateTime(2020, 10, 5, 14, 42, 32, 666, DateTimeKind.Local), Username = "safkhan" }
                    );
                });
