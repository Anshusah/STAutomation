...
namespace Cicero.Data.Cicero.Data.Migrations.SimpleTransferApplicationDb
{
    ...
    [Migration("20200407052905__rateSupplierFeeConfig_added")]
    partial class _rateSupplierFeeConfig_added
    {
            ...
            modelBuilder.Entity("Cicero.Data.Entities.SimpleTransfer.CountryList", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Code = "AF", CreatedBy = "df0d5fc1-b3c9-448f-afea-a43cd08005a6", CreatedDate = new DateTime(2020, 4, 7, 11, 14, 4, 453, DateTimeKind.Local), CurrencyCode = "", CurrencyName = "", DisplayOrder = 0, FlagCode = "", FlagImageUrl = "", IsActive = false, Name = "Afghanistan", UpdatedBy = "df0d5fc1-b3c9-448f-afea-a43cd08005a6", UpdatedDate = new DateTime(2020, 4, 7, 11, 14, 4, 453, DateTimeKind.Local) },
            ...
            modelBuilder.Entity("Cicero.Data.Entities.SimpleTransfer.Gender", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Code = "M", CreatedBy = "df0d5fc1-b3c9-448f-afea-a43cd08005a6", CreatedDate = new DateTime(2020, 4, 7, 11, 14, 4, 456, DateTimeKind.Local), Name = "Male", Status = true, TenantId = 0, UpdatedBy = "", UpdatedDate = new DateTime(2020, 4, 7, 11, 14, 4, 456, DateTimeKind.Local) },
                        new { Id = 2, Code = "F", CreatedBy = "df0d5fc1-b3c9-448f-afea-a43cd08005a6", CreatedDate = new DateTime(2020, 4, 7, 11, 14, 4, 456, DateTimeKind.Local), Name = "Female", Status = true, TenantId = 0, UpdatedBy = "", UpdatedDate = new DateTime(2020, 4, 7, 11, 14, 4, 456, DateTimeKind.Local) }
                    );
                });
            ...
            modelBuilder.Entity("Cicero.Data.Entities.SimpleTransfer.RateSupplier", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedAt = new DateTime(2020, 4, 7, 11, 14, 4, 451, DateTimeKind.Local), IsActive = true, Name = "Tranfast", Password = "P@ssw0rd", RatePriority = 1, SystemId = "1AB804F0-9252-4A7E-885A-276B65540D84", UpdatedAt = new DateTime(2020, 4, 7, 11, 14, 4, 450, DateTimeKind.Local), Username = "transfast" },
                        new { Id = 2, CreatedAt = new DateTime(2020, 4, 7, 11, 14, 4, 451, DateTimeKind.Local), IsActive = true, Name = "NecMoney", Password = "P@ssw0rd", RatePriority = 2, SystemId = "9D6D65E4-EFF1-4752-892D-3F637A56C159", UpdatedAt = new DateTime(2020, 4, 7, 11, 14, 4, 451, DateTimeKind.Local), Username = "necmoney" },
                        new { Id = 3, CreatedAt = new DateTime(2020, 4, 7, 11, 14, 4, 451, DateTimeKind.Local), IsActive = true, Name = "Safkhan", Password = "P@ssw0rd", RatePriority = 3, SystemId = "D93C65D4-7AA9-4A84-B23F-BEBB8D324476", UpdatedAt = new DateTime(2020, 4, 7, 11, 14, 4, 451, DateTimeKind.Local), Username = "safkhan" }
                    );
                });
