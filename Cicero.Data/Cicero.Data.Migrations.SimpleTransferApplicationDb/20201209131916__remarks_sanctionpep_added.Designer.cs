...
namespace Cicero.Data.Cicero.Data.Migrations.SimpleTransferApplicationDb
{
    ...
    [Migration("20201209131916__remarks_sanctionpep_added")]
    partial class _remarks_sanctionpep_added
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cicero.Data.Entities.SimpleTransfer.Customer", b =>
                {
                    ...
                    b.Property<int>("KycFailedCount");

                    b.Property<bool>("KycManualPass");

                    b.Property<DateTime?>("KycManualPassDate");
            ...
            modelBuilder.Entity("Cicero.Data.Entities.SimpleTransfer.LexisNexis", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("EquifaxUsername");

                    b.Property<string>("Ikey");

                    b.Property<string>("LexisNexisId");
                    ...
                    b.Property<bool>("SanctionMatch");

                    b.Property<string>("ScoreCard");

                    b.Property<string>("UKLexIdField");
            ...
            modelBuilder.Entity("Cicero.Data.Entities.SimpleTransfer.RateSupplier", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedAt = new DateTime(2020, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), IsActive = true, Name = "Tranfast", Password = "P@ssw0rd", RatePriority = 1, SystemId = "1AB804F0-9252-4A7E-885A-276B65540D84", UpdatedAt = new DateTime(2020, 12, 9, 19, 4, 14, 892, DateTimeKind.Local), Username = "transfast" }
                    );
                });
            ...
            modelBuilder.Entity("Cicero.Data.Entities.SimpleTransfer.SanctionPepBeneficiary", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("LexisNexisId");

                    b.Property<int>("PepsType");
                    ...
                    b.ToTable("SanctionPepBeneficiary");
                });

            modelBuilder.Entity("Cicero.Data.Entities.SimpleTransfer.SanctionPepCustomer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<bool>("NewMatchVerified");

                    b.Property<int>("PepsType");

                    b.Property<bool>("PeriodicVerified");
                    ...
                    b.ToTable("SanctionPepCustomer");
                });

            modelBuilder.Entity("Cicero.Data.Entities.SimpleTransfer.SanctionPepPerson", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<string>("AddressesField");

                    b.Property<string>("AliasesField");

                    b.Property<string>("CountryField");

                    b.Property<string>("CreatedBy");

                    b.Property<DateTime>("CreatedDate");

                    b.Property<string>("DOBField");

                    b.Property<string>("ExceptionsField");

                    b.Property<int>("LexisNexisId");

                    b.Property<int>("MatchScoreField");

                    b.Property<string>("NameField");

                    b.Property<string>("PositionsField");

                    b.Property<string>("RecencyField");
            ...
            modelBuilder.Entity("Cicero.Data.Entities.SimpleTransfer.STPaymentRequestDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("PurposeOfRequest");

                    b.Property<string>("Reminder");

                    b.Property<string>("STPaymentRequestId");
                    ...
                    b.ToTable("STPaymentRequestDetails");
                });
            ...
            modelBuilder.Entity("Cicero.Data.Entities.UatSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("UatSetting");

                    b.HasData(
                        new { Id = 1, PhoneNumber = "", Status = false }
                    );
                });
