...
namespace Cicero.Data.Migrations
{
    ...
    [Migration("20181120112107_Initial10")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cicero.Data.Entities.CaseChangeReason", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Cicero.Data.Entities.Case", b =>
                {
                    b.HasOne("Cicero.Data.Entities.CaseForm", "CaseClaim")
                        .WithMany()
                        .HasForeignKey("ClaimTypeId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Cicero.Data.Entities.DamageCategory", "DamageCategory")
                        .WithMany()
