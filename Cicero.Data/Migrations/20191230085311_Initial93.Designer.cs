...
namespace Cicero.Data.Migrations
{
    ...
    [Migration("20191230085311_Initial93")]
            ...
            modelBuilder.Entity("Cicero.Data.Entities.MailMergeField", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Alias = "[First_Name]", DbSourceField = "FirstName", DbSourceTable = "User", FieldName = "First Name", FormId = 0, TemplateType = 1, TenantId = 1 },
                        new { Id = 2, Alias = "[Last_Name]", DbSourceField = "LastName", DbSourceTable = "User", FieldName = "Last Name", FormId = 0, TemplateType = 1, TenantId = 1 },
                        new { Id = 3, Alias = "[Email]", DbSourceField = "Email", DbSourceTable = "User", FieldName = "Email", FormId = 0, TemplateType = 1, TenantId = 1 },
                        new { Id = 4, Alias = "[Updated_Date]", DbSourceField = "UpdatedAt", DbSourceTable = "User", FieldName = "Updated Date", FormId = 0, TemplateType = 1, TenantId = 1 },
                        new { Id = 5, Alias = "[Address]", DbSourceField = "Address", DbSourceTable = "User", FieldName = "Address", FormId = 0, TemplateType = 1, TenantId = 1 },
                        new { Id = 6, Alias = "[Phone_Number]", DbSourceField = "PhoneNumber", DbSourceTable = "User", FieldName = "Phone Number", FormId = 0, TemplateType = 1, TenantId = 1 },
                        new { Id = 7, Alias = "[Role_Name]", DbSourceField = "DisplayName", DbSourceTable = "Role", FieldName = "RoleName", FormId = 0, TemplateType = 1, TenantId = 1 },
                        new { Id = 8, Alias = "[Form_Name]", DbSourceField = "Name", DbSourceTable = "CaseForm", FieldName = "Form Name", FormId = 0, TemplateType = 2, TenantId = 1 }
                    );
                });
