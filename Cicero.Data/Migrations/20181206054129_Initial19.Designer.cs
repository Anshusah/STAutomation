...
namespace Cicero.Data.Migrations
{
    ...
    [Migration("20181206054129_Initial19")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cicero.Data.Entities.Setting", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = 6, FieldDisplay = "Starting Claim", FieldGridSize = "6", FieldKey = "app_claim", FieldType = "TENANTCLAIM", FieldValue = "", FieldVisiblity = 1 },
                        new { Id = 7, FieldDisplay = "Role for register User", FieldGridSize = "6", FieldKey = "app_user_role", FieldType = "USERROLE", FieldValue = "", FieldVisiblity = 1 },
            ...
            modelBuilder.Entity("Cicero.Data.Entities.Message", b =>
                {
                    ...
                    b.HasOne("Cicero.Data.Entities.ApplicationUser", "Receiver")
                        .WithMany("Receivers")
                        .HasForeignKey("To")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("Cicero.Data.Entities.State", b =>
                {
                    b.HasOne("Cicero.Data.Entities.ApplicationRole", "Role")
                        .WithMany("RoleStates")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Restrict);
