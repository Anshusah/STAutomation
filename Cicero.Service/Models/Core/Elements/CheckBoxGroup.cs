...
{
    public class CheckBoxGroup : Element
    {
        ...
        public string BackendId { get; set; } = "CheckBoxGroup" + Utils.GenerateId();
        public string BackendClass { get; set; } = "";
        public string BackendLabel { get; set; }
        public bool BackendVisible { get; set; } = true;
        public string FrontendId { get; set; } = "CheckBoxGroup" + Utils.GenerateId();
        ...
        public string FrontendCheckboxStyle { get; set; } = CheckboxStyle.Stack.ToString();
        public string BackendCheckboxStyle { get; set; } = CheckboxStyle.Stack.ToString();
