...
{
    public class CustomerUserViewModel : IValidatableObject
    {
        ...
        [Display(Name = "Sanction Match")]
        public string IsSanctionMatch { get; set; }

        [Display(Name = "Pep Match")]
        public string IsPepMatch { get; set; }
        ...
        public List<SelectListItem> LexisNexisReports { get; set; }

        public List<SanctionPepPersonViewModel> SanctionPepPerson { get; set; }

        //[CustomValidation(typeof(CustomPersonValidation), nameof(CustomPersonValidation.PersonIdValidate))]
        public int PersonId { get; set; }

        public string Match { get; set; }

        //[CustomValidation(typeof(CustomPersonValidation), nameof(CustomPersonValidation.RemarksValidate))]
        ...
        {
            if (Match == "confirmMatch" && PersonId == 0)
            {
                yield return new ValidationResult(
                   $"Please select matched person.",
                   new[] { "PersonId" });
            }

            if (!(string.IsNullOrEmpty(Match)) && string.IsNullOrEmpty(Remarks))
            {
                yield return new ValidationResult(
