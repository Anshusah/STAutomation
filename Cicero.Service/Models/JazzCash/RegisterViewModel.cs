...
namespace Cicero.Service.Models.JazzCash
{
    public class RegisterViewModel
    {
        ...
        [Remote("CheckIfMobileNumberExistsJazzCash", "User", "Admin", ErrorMessage = "There is an existing account with this number. Please contact customer support if this is your number.", HttpMethod = "Post", AdditionalFields = "MobileNumber")]
